 ...
 */
public class IntervalSet implements Iterable<Interval> {//, ErrorReporter {

  private Interval[] r;
  private int length;

  //	private ErrorLog error = new ErrorLog("IntervalSet");
  ...
  //  /** Equality between IntervalSets. */
  //  public boolean equals(Object o) {
  //    IntervalSet s2 = (IntervalSet) o;
  //
  //    if (length != s2.length) {
  //      return false;
  //    }
  //
  //    for (int i = 0; i < length; i++) {
  //      if (r[i].low != s2.r[i].low || r[i].up != s2.r[i].up) {
  //        return false;
  //      }
  //    }
  //
